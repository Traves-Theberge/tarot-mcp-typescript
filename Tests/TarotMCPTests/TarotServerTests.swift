//
//  TarotServerTests.swift
//  swift-tarot-MCP
//
//  Created by June Bash on 6/5/25.
//
...
struct TarotServerTests {
  ...
  func testListToolsEndToEnd() async throws {
    ...
    {"jsonrpc":"2.0","id":1,"method":"initialize","params":{"protocolVersion":"2024-11-05","capabilities":{"tools":{}},"clientInfo":{"name":"TestClient","version":"1.0.0"}}}
    """
    ...
    continuation.yield(initializeRequest.data(using: .utf8)!)
    await Task.megaYield()
    
    continuation.yield(initializedNotification.data(using: .utf8)!)
    await Task.megaYield()
    
    continuation.yield(listToolsRequest.data(using: .utf8)!)
    await Task.megaYield()
  ...
  func testCallToolEndToEnd() async throws {
    ...
    let callToolRequest = """
    {"jsonrpc":"2.0","id":2,"method":"tools/call","params":{"name":"draw_single_card","arguments":{}}}
    """
    ...
    continuation.yield(callToolRequest.data(using: .utf8)!)
    await Task.megaYield()
  ...
  func testListResourcesEndToEnd() async throws {
    ...
    // Create MCP initialization sequence
    let initializeRequest = """
    {"jsonrpc":"2.0","id":1,"method":"initialize","params":{"protocolVersion":"2024-11-05","capabilities":{"resources":{}},"clientInfo":{"name":"TestClient","version":"1.0.0"}}}
    """
    ...
    continuation.yield(listResourcesRequest.data(using: .utf8)!)
    await Task.megaYield()
  ...
  func testListPromptsEndToEnd() async throws {
    ...
    // Create MCP initialization sequence
    let initializeRequest = """
    {"jsonrpc":"2.0","id":1,"method":"initialize","params":{"protocolVersion":"2024-11-05","capabilities":{"prompts":{}},"clientInfo":{"name":"TestClient","version":"1.0.0"}}}
    """
    ...
    continuation.yield(listPromptsRequest.data(using: .utf8)!)
    await Task.megaYield()
  ...
  func testCallToolInvalidCountErrorMessage() async throws {
    ...
    let callToolRequest = """
    {"jsonrpc":"2.0","id":2,"method":"tools/call","params":{"name":"draw_multiple_cards","arguments":{"count":0}}}
    """
